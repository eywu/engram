...
**Owner:** Eric (capture) → BrownBear (assemble doc)
**Tracks:** GRO-471
...
**If you don't have a personal workspace yet:** create one at https://slack.com/create. Takes ~90 seconds. You can name it anything (e.g. "BrownBear Test").
...
Total time on my end after handoff: ~30 min. Let me know if you hit any UI surprises and I'll adjust the spec.
